...
var file_proto_taskqueue_proto_depIdxs = []int32{
	...
	18, // 6: taskqueue.Worker.metadata:type_name -> taskqueue.Worker.MetadataEntry
	9,  // 7: taskqueue.RegisterWorkerRequest.worker:type_name -> taskqueue.Worker
	2,  // 8: taskqueue.FetchTaskResponse.task:type_name -> taskqueue.Task
	3,  // 9: taskqueue.TaskQueue.SubmitTask:input_type -> taskqueue.SubmitTaskRequest
	7,  // 10: taskqueue.TaskQueue.GetTaskResult:input_type -> taskqueue.GetTaskResultRequest
	5,  // 11: taskqueue.TaskQueue.GetTaskStatus:input_type -> taskqueue.GetTaskStatusRequest
	10, // 12: taskqueue.WorkerService.RegisterWorker:input_type -> taskqueue.RegisterWorkerRequest
	14, // 13: taskqueue.WorkerService.FetchTask:input_type -> taskqueue.FetchTaskRequest
	16, // 14: taskqueue.WorkerService.SubmitResult:input_type -> taskqueue.SubmitResultRequest
	12, // 15: taskqueue.WorkerService.Heartbeat:input_type -> taskqueue.HeartbeatRequest
	4,  // 16: taskqueue.TaskQueue.SubmitTask:output_type -> taskqueue.SubmitTaskResponse
	8,  // 17: taskqueue.TaskQueue.GetTaskResult:output_type -> taskqueue.GetTaskResultResponse
	6,  // 18: taskqueue.TaskQueue.GetTaskStatus:output_type -> taskqueue.GetTaskStatusResponse
	11, // 19: taskqueue.WorkerService.RegisterWorker:output_type -> taskqueue.RegisterWorkerResponse
	15, // 20: taskqueue.WorkerService.FetchTask:output_type -> taskqueue.FetchTaskResponse
	17, // 21: taskqueue.WorkerService.SubmitResult:output_type -> taskqueue.SubmitResultResponse
	13, // 22: taskqueue.WorkerService.Heartbeat:output_type -> taskqueue.HeartbeatResponse
